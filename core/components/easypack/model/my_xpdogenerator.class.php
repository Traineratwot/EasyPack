<?php
	 ...
	 */
	if (isset($dbType) and !class_exists('xPDOGenerator_mysql')) {
		$test = include_once(XPDO_CORE_PATH . 'om/' . $dbType . '/xpdogenerator.class.php');
	}
	if (!$test or !class_exists('xPDOGenerator_mysql')) {
		exit();
	}
