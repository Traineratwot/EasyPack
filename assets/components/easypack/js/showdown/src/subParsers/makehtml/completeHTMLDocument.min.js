...
showdown.subParser('makehtml.completeHTMLDocument',function(text,options,globals){'use strict';if(!options.completeHTMLDocument){return text;}
...
//# sourceMappingURL=completeHTMLDocument.min.js.map
